...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>Espace Apprenants</h1>
            <p>Consultez votre planning et gérez vos émargements</p>
        </div>
        ...
        <div class="grid">
            <a href="/accueil" class="card">
                ...
                <div class="card-text">
                    ...
                    <p>Consulter vos cours du jour</p>
                </div>
            </a>
            <a href="#" class="card">
                <span class="card-icon">📎</span>
                <div class="card-text">
                    <h3>Envoi des justificatifs</h3>
                    <p>Déposer un certificat ou justificatif</p>
                </div>
            </a>
            <a href="/emargement/create" class="card">
                <span class="card-icon">✍️</span>
                <div class="card-text">
                    <h3>Signature des documents</h3>
                    <p>Émarger votre présence</p>
                </div>
            </a>
        </div>
